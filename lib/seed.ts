...
const agents: Agent[] = [
  ...
  // ── Marketing/Growth: social/content crew ───────────────────────────
  {
    ...
    status: 'active',
    tier: 'lead',
    description: 'Owns the legacy social/content pillar. The real production surface is Content Studio (social-content-studio, growth-marketing, social-publishing, ad-creative-research) — this instance now only carries the DM automation lane.',
    model: 'aggregate of workers',
    tools: ['dmflow'],
    parentId: null,
    instance: 'builtin',
  ...
  },
  {
    ...
    status: 'active',
    tier: 'lead',
    description: 'Owns the legacy sales pillar. The named account lanes (Vantage, Launchpad Cohort) and the Ledger CRM connection were a prior operator\'s demo data, removed 2026-08-28 — this instance now only carries the calls-data lane pending a real CRM connection.',
    model: 'aggregate of workers',
    tools: ['stripe', 'recall'],
    parentId: null,
    instance: 'builtin',

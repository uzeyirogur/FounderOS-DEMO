...
const ROUTES: RouteEntry[] = [
  ...
  { route: 'errors', load: () => import('@/app/api/errors/route'), url: 'http://localhost/api/errors' },
  ...
  { route: 'content-pieces', load: () => import('@/app/api/content-pieces/route'), url: 'http://localhost/api/content-pieces' },
  ...
  { route: 'creative-briefs', load: () => import('@/app/api/creative-briefs/route'), url: 'http://localhost/api/creative-briefs' },
  ...
  { route: 'projects/[id]/lifecycle/evidence', load: () => import('@/app/api/projects/[id]/lifecycle/evidence/route'), url: 'http://localhost/api/projects/anka-tivaro/lifecycle/evidence', params: { id: 'anka-tivaro' } },
